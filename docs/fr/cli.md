...
`@deno-inertia/cli` est un outil en ligne de commande pour créer et gérer
...
```bash
deno run -A jsr:@deno-inertia/cli init mon-app
```
...
inertia init [nom]
# ou
deno run -A jsr:@deno-inertia/cli init [nom]
```
